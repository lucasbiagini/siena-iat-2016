...
if (!$mysqli->query("INSERT INTO trials (idiat, trial_seq, trial_number,
  response_time, item, category, error, block) VALUES ".$values_mysql."")) {
	...
	//echo "Remember whether the score you got is positive or negative. This information be used next.";
}
...
echo "<br>A positive score correlates to an implicit association between Females
and Computer Science; a negative score correlates to Males and Computer Science.
<br><br>Less than -1 or greater than 1 corresponds to a strong association.";
echo "<br><br>Now the developers might teach you how to cheat; we'll see how far we get."
